    ...
    <div class="container" style="margin-top:80px">
        ...
        <div class="row">
     	...
     	<div class ="container mt-3" style ="text-align:right">
          ...
          <div class="container mt-3" style="text-align:right;">
            <button type = "button" class="btn btn-secondary" onclick = "gallerywrite()">글쓰기</button>
          </div>
...
<script>
	...
	function goView(id){
		...
		frm.id.value = id;
		frm.method = "get";
		frm.action = "${pageContext.request.contextPath}/gallery/write";
		frm.submit();
	}
	...
	function gallerywrite(){
		...
		location.href="${commonURL}/gallery/write";
